...
export default function Resistencia() {
    ...
    return (
        <div className='container content-city mx-auto'>
            <div className='row'>
                <h2 className='h2 first-title'>I - CIRCUNSCRIPCIÒN RESISTENCIA |<br />Civiles Av. 9 de Julio Nº 466 | Cel Turno: 3624-902841</h2>
            </div>
            <div className='row'>
                <div className='item item--3 first--city'>
                    ...
                    <h6>Asesoria de NNA N° 1:<br /> Dra. Natalia Raquel Fachin</h6>
            ...
            <div className='row'>
                <div className='item item--3'>
                    ...
                    <h6>Asesoria de NNA N° 2:<br /> Dra. Romina Soledad Cima</h6>
                    <ul className='item--info'>
                        {/* <li><span><img className='img-fluid' src={iconArroba} alt='Teléfono'/></span></li> */}
                ...
                <div className='item item--3'>
                    ...
                    <h6>Asesoria de NNA N° 5:<br /> Dra. Gabriela Carolina Coleff</h6>
                    <ul className='item--info'>
                        {/* <li><span><img className='img-fluid' src={iconArroba} alt='Teléfono'/></span></li> */}
                ...
                <div className='item item--3'>
                    ...
                    <h6>Asesoria de NNA N° 5:<br /> Dra. Patricia Noemi Zamudio</h6>
                    <ul className='item--info'>
                        {/* <li><span><img className='img-fluid' src={iconArroba} alt='Teléfono'/></span></li> */}
