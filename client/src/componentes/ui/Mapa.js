            ...
            <>
                <div className='content-map'>
                    <div class='map'>
                            ...
                            <NavLink to="/miembros/castelli" activeclassname="active"><g><path fill="#EBC862" className="localidad" id="castelli" d="M296.199,158.153v10.204h1.7v139.446h173.459v10.205h1.7v8.435l40.813-1.633v11.905v113.938H624.41v8.502
                            ...
                            <NavLink to="/miembros/charata" activeclassname="active"><g><path fill="#CCE4A8" className="localidad" id="charata" d="M406,583.494h160.352v39.66c0,0,15.191,5.173,18.567,8.622c3.376,3.448,3.376-3.449,10.127,0
                            ...
                            <NavLink to="/miembros/saenzPeña" activeclassname="active"><g><path fill="#BCE4FA" className="localidad" id="saenz-penia" d="M846.886,499.255h-95.232v67.139l-134.346-45.318v-60.424H506.771V338.123h-42.514V319.66H289.098V171.956
                            ...
                            <NavLink to="/miembros/villaAngela" activeclassname="active"><g><path fill="#BCE4FA" className="localidad" id="villa-angela" d="M722.743,683.415c-13.604-5.111-11.903-5.111-22.107-6.815c-10.204-1.705-5.102-1.705-15.305-5.111
                            ...
                            <NavLink to="/miembros/resistencia" activeclassname="active"><g><path fill="#EBC862" className="localidad" id="resistencia" d="M1180.311,620.381l-46.823-38.407c0,0-13.379-6.983-18.396-6.983s-13.379,1.745-35.118,17.458
                            ...
                            <NavLink to="/miembros/sanMartin" activeclassname="active"><g><path fill="#CCE4A8" className="localidad" id="san-martin" d="M1098.568,572.396c0,0-7.936-4.948-17.512-18.479c-9.575-13.531-11.172-12.027-41.494-22.552
