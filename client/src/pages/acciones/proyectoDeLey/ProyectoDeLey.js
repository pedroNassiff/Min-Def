...
const ProyectoDeLey = () => {
    ...
    useEffect(() => {
      // trayendo Acciones
      getData(`${domain}/wp-json/wp/v2/acciones?filter[meta_key]=area&filter[meta_value]=proyectos-de-ley`);
    }, []);

    const searchFilter = (search) => {
      getData(`${domain}/wp-json/wp/v2/acciones?filter[meta_key]=area&filter[meta_value]=proyectos-de-ley&search=${search}`);
    }

    return (
        <div className="bibliotecaContainer">
            <div className="titleContainer">
                <h1>Acciones - Proyecto De Ley</h1>
                <span>
