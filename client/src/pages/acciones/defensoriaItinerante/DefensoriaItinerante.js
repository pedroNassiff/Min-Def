...
import './DefensoriaItinerante.scss'
...
const DefensoriaItinerante = () => {
    ...
    useEffect(() => {
      // trayendo Acciones
      getData(`${domain}/wp-json/wp/v2/acciones?filter[meta_key]=area&filter[meta_value]=defensoria-itinerante`);
    }, []);

    const searchFilter = (search) => {
      getData(`${domain}/wp-json/wp/v2/acciones?filter[meta_key]=area&filter[meta_value]=defensoria-itinerante&search=${search}`);
    }

    return (
        <div className="bibliotecaContainer">
            <div className="titleContainer">
                <h1>Acciones - Defensoria Itinerante</h1>
                <span>
...
export default DefensoriaItinerante;